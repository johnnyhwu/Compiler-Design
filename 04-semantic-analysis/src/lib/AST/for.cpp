...
void ForNode::visitChildNodeVarDecl(AstNodeVisitor &p_visitor) {
    var_decl->accept(p_visitor);
}

void ForNode::visitChildNodeInit(AstNodeVisitor &p_visitor) {
    initial_statement->accept(p_visitor);
}

void ForNode::visitChildNodeCond(AstNodeVisitor &p_visitor) {
    condition->accept(p_visitor);
}

void ForNode::visitChildNodeBody(AstNodeVisitor &p_visitor) {
    body->accept(p_visitor);
}
